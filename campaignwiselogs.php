...
<?php include_once(dirname(__FILE__).'/templateheader.php'); ?>
      ...
      <div class="content-wrapper">
		...
		</h6><font color=red>Current month's reports will be available here</font></h6>
                <div class="well">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		oTable = $('#campaignsTable').dataTable( {
			...
			"lengthChange": false,
			"ordering": false,
			"sAjaxSource": "scripts/campaignwisedetails.php",
	...
	function fetch_data(is_date_search, start_date='', end_date='', campaigntag) {
		var dataTable = $('#campaignsTable').DataTable({
					...
					"order" : [],
					"ajax" : {
						url:"scripts/campaignwisedetails.php",
						type:"POST",
						data:{
	...
	function fnFilter() {
		...
		oTable.fnReloadAjax('scripts/campaignwisedetails.php?'+params);
